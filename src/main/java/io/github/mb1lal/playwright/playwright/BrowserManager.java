package io.github.mb1lal.playwright.playwright;

import io.github.mb1lal.playwright.base.TestContext;
import io.github.mb1lal.playwright.config.ConfigManager;
...
/**
 * Owns the Playwright browser lifecycle for a single test.
 *
 * <p>All state is held in {@link ThreadLocal}s so scenarios can run in
 * parallel. A single instance is shared per test through
 * {@code io.github.mb1lal.playwright.support.BaseUiTest}.
 */
@Slf4j
